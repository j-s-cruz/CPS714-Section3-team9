...
import { GiBiceps, GiRunningShoe, GiWeightLiftingUp, GiMuscleUp } from 'react-icons/gi';
...
export const MemberDashboard = () => {
  ...
  useEffect(() => {
    if (myProfile?.id) {
      fetchAchievements(myProfile.id);
  ...
  const fetchAchievements = async (userId: string) => {
    ...
    console.log("Raw achievements data:", data, error);
